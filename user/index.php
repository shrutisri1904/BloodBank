			...
			<div class="row">
				<div class="col-md-12 col-md-push-1">
					<div class="panel panel-default" style="padding: 20px;">
						<div class="panel-body">
					 	...
					 	?>
							...
							<p class="text-center">Here you can manage your account update your profile</p>
							 <div class="test-success text-center" id="date" style="margin-top:20px;"><?php
							 if(isset($showForm))
							 echo $showForm; ?></div>
							<?php 
							...
							type="submit" class="btn btn-lg btn-danger center-aligned ">Become a Life Saver</button>
						</form>
							';
                              }
                              else
                              {
                                 ...
                                 if($diffMonth>=3)
                                 {
                                   echo '<form target="" method="post">
							<button style="margin-top: 20px;" name="date" id="save_the_life"
							type="submit" class="btn btn-lg btn-danger center-aligned ">Save The Life</button>
						</form>
							';
                                 }
                                 else
             		...
             		<span>You already saved a life. You will donate the blood after three months. We are very thankfull to you.</span> 
             		</div>'; 
                                 }
